...
When authentication is enabled (see [Settings - Security](/basics/settings#security)), the dashboard requires a password to log in. For programmatic access (scripts, curl), use the API token shown in Settings.
