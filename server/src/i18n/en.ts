export default {
  ...
  label: {
    ...
    nightVision: "Night vision detection",
    nightVisionThreshold: "Magenta threshold",
  ...
  toast: {
    ...
    nightVisionEnabled: "Night vision detection enabled",
    nightVisionDisabled: "Night vision detection disabled",
    nightVisionSaved: "Night vision settings saved",
  ...
  help: {
    ...
    nightVision: "Detect IR illumination from NoIR cameras and show a badge on the live feed",
    nightVisionThreshold: "Percentage of pink/magenta pixels needed to trigger night mode. Lower values are more sensitive.",
