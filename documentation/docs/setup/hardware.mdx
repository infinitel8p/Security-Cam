...
:::note
Please ignore possible occurences of the Raspberry Pi Zero **1** W in the instructions. The instructions were originally written for the Raspberry Pi Zero W but were updated to work with the Raspberry Pi Zero 2 W it is recommended for it's better performance.
:::
...
If you have a Raspberry Pi Zero 2 W and you have not yet soldered the GPIO header, you can do so now (You should probably remove the camera flex cable from the raspberry first). The magnet reed switch will be connected to the Raspberry Pi as shown below.
...
<div style={{ display: "flex" }}>
	<img
		src="https://github.com/infinitel8p/Security-Cam/assets/50703696/23d48c70-2e41-4f6f-baf1-836163926949"
		alt="Image 1"
		width="400"
	/>
	<img
		src="https://github.com/infinitel8p/Security-Cam/assets/50703696/be0c37e0-1c15-44e3-8dba-51f63615c5c3"
		alt="Image 2"
		width="400"
	/>
</div>
...
:::note
For the connections on the Raspberry you can refer the diagram shown [here](#raspberry-pi-connection) again
:::
