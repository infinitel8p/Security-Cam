...
needs_cv2 = pytest.mark.skipif(not HAS_CV2, reason="OpenCV/numpy not installed")
...
# -- API integration test (no OpenCV needed) ---------------------------------
...
# -- Frame analysis tests (require OpenCV) ------------------------------------
...
# -- Check loop tests (require OpenCV for frame creation) ---------------------
