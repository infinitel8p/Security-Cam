...
:::tip
After setup is complete, you can also pair new Bluetooth devices directly from the dashboard at **Settings > Devices** — no SSH needed. The dashboard supports both scanning and making the Pi discoverable. See [Bluetooth pairing from the dashboard](../basics/dashboard#bluetooth-pairing-from-the-dashboard) for details.
:::
